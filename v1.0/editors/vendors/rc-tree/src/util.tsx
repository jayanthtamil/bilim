...
import { NodeElement, Key, DataNode, Entity, NodeInstance } from "./interface";
...
export function isCheckDisabled(node: NodeElement) {
  const { disabled, disableCheckbox, checkable } = (node.props ||
    {}) as NodeElement["props"];
